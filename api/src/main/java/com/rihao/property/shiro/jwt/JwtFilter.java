...
import com.rihao.property.util.HttpServletResponseUtil;
...
public class JwtFilter extends AuthenticatingFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        HttpServletResponseUtil.printJSON(httpServletResponse, ResBody.custom(ErrorCode.PERMISSION_EXPIRED));
        return false;
    }
